 ...
 */
package org.unix.utility.object;
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource().equals(btn_search)) {
            if (!text_search.getText().isEmpty()) {
                text_output.setText("");
                SimpleEntityQuery<SimpleSceneObject> fm = c.objects.populate().filter((n) -> (n.getName() != null && n.getName().toLowerCase().contains(text_search.getText().toLowerCase())));
                if (fm.isEmpty())
                    return;
                for (SimpleSceneObject sso : fm) {
                    if (sso != null) {
                        text_output.setText(text_output.getText() + "Name: " + sso.getName() + " | id: " + sso.getId() + " | Dist: " + sso.distanceTo(c.players.getLocal().getLocation()) + "\n");
                    }
                }
            }
        }
